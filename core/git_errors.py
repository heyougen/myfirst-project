def humanize_git_error(message: str) -> str:
    ...
    if "already exists" in lower and "tag" in lower:
        return "该版本 tag 已存在。请换一个版本号，或先确认是否已经发布过该版本。"
